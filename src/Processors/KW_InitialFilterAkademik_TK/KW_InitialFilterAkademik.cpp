...
KW_InitialFilterAkademik::KW_InitialFilterAkademik(const std::string & name) : Base::Component(name),
		...
		blue_B("grupa1|  down_blue_B", 37, "range"),
		blue_R("grupa1|  up_blue_R", 212, "range"),
		blue_G("grupa1|  up_blue_G", 121, "range"),

		green_G("grupa2|  down_green_G", 48, "range"),
		green_R("grupa2|  up_green_R", 187, "range"),
		green_B("grupa2|  up_green_B", 255, "range"),

		dark_R("grupa3|  up_dark_R", 28, "range"),
		dark_G("grupa3|  up_dark_G", 73, "range"),
		dark_B("grupa3|  up_dark_B", 80, "range"),
